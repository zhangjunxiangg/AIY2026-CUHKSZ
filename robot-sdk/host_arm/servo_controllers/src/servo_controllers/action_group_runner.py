...
class ActionGroupRunner:
    ...
    def __init__(self,
        ...
        self.path = path or os.environ.get("ROBOT_ACTION_GROUP_DIR", "/data/robot/ActionGroups")
        ...
        try:
            with open(path, 'r') as f:
                ...
                for action in actions:
                    ...
                    acts.append((duration_ms, tuple(map(lambda id_: (int(id_), joints[id_], duration_s), ids))))
                ret = acts
