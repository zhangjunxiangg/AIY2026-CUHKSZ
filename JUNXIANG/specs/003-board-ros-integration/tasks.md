...
- [ ] T018 [US3] OFFLINE: Write failing LaserScan raw-field/source-time/receive-time and target schema/validity/frame/confidence/provenance/staleness conversion tests for FR-010/FR-011 in `control_ws/src/student_tasks/test/test_ros_providers.py`
- [ ] T019 [US3] SOURCE: Implement thread-safe scan and versioned JSON target providers with dual-time evidence and structured failures for FR-010/FR-011 in `control_ws/src/student_tasks/src/student_tasks/ros_providers.py`
...
- [ ] T029 [P] SOURCE: Document ROS CLI examples, measured configuration workflow, and explicit HIL boundary in `control_ws/src/student_tasks/README.md`
