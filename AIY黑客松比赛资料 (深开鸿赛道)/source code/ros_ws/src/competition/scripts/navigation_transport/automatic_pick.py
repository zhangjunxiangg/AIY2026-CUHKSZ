...
def start_pick_callback(msg):
    ...
    param = rospy.get_param('/position_correction/pick_stop_pixel_coordinate')
    pick_stop_x = 320 
    pick_stop_y = 300
    stop = True
...
if __name__ == '__main__':
    ...
    # rospy.Subscriber("/robot_1/gemini_camera/rgb/image_raw", Image, image_callback)
